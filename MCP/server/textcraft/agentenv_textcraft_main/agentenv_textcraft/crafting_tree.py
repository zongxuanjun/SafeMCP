...
class CraftingTree:
    ...
    def __init__(self, minecraft_dir):
        # minecraft_dir = os.path.abspath(os.path.expanduser(minecraft_dir))
        minecraft_dir = os.path.realpath(os.path.expanduser(minecraft_dir))
        if not os.path.isdir(minecraft_dir):
            minecraft_dir = "/root/wrp/MCP-A2A/MCP/server/textcraft/agentenv_textcraft_main/agentenv_textcraft/"
        print('minecraft_dir:',minecraft_dir) # test
...
def main():
    tree = CraftingTree(minecraft_dir="/root/wrp/MCP-A2A/MCP/server/textcraft/agentenv_textcraft_main/agentenv_textcraft/")
